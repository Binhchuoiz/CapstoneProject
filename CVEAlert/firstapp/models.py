...
class CVE(models.Model):
    ...
    date_reserved = models.CharField(max_length=255, default="")
    date_publish = models.CharField(max_length=255, default="")
    date_update = models.CharField(max_length=255, default="")
    assigner_Org_Id = models.CharField(max_length=255, default="")
    provider_Metadata = models.CharField(max_length=255, default="")

    def __str__(self) -> str:
        return super(self.cve_id).__str__(self.cve_id)
    
class Descriptions(models.Model):
    con_id = models.ForeignKey(CVE, on_delete=models.CASCADE, related_name='description_cves', blank=True, default=None)
    value = models.CharField(max_length=9000, default="")

    def __str__(self) -> str:
        return super(self.value).__str__(self.value)
    
class Solutions(models.Model):
    con_id = models.ForeignKey(CVE, on_delete=models.CASCADE, related_name='solutions_cves', blank=True, default=None)
    value = models.CharField(max_length=9000, default="")
...
class Versions(models.Model):
    version = models.CharField(max_length=3000, default="")
...
class Affected(models.Model):
    con_id = models.ForeignKey(CVE, on_delete=models.CASCADE, related_name='affected_cves', blank=True, default=None)
...
class References(models.Model):
    con_id = models.ForeignKey(CVE, on_delete=models.CASCADE, related_name='references_cves', blank=True, default=None)
    url = models.CharField(max_length=3000, default="")
...
class CvssV20(models.Model):
    ...
    vector_string = models.CharField(max_length=300, default="")
...
class CvssV30(models.Model):
    ...
    vector_string = models.CharField(max_length=300, default="")
    base_score = models.FloatField(default="")
    base_severity = models.CharField(max_length=255, default="")
...
class CvssV31(models.Model):
    version = models.CharField(max_length=255, default="")
    vector_string = models.CharField(max_length=400, default="")
    base_score = models.FloatField(default="")
    base_severity = models.CharField(max_length=255, default="")
...
class Metric(models.Model):
    con_id = models.ForeignKey(CVE, on_delete=models.CASCADE, related_name='metric_cve', blank=True, default=None)
    ...
    def __str__(self) -> str:
        return super(self.con_id).__str__(self.con_id)
